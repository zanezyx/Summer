...
import com.zyx.duomimanager.application.AppApplication;
import com.zyx.duomimanager.commication.BaseRequest;
import com.zyx.duomimanager.commication.BaseResponse;
import com.zyx.duomimanager.commication.HttpClient;
import com.zyx.duomimanager.component.LoadingDialog;
...
public abstract class BaseService<REQUEST extends BaseRequest, RESPOND extends BaseResponse> {
	...
	class NetAsyncTask extends AsyncTask<Void, Void, integer> {
		...
		protected void onPreExecute() {
			...
			if (request.getmShowType() == BaseRequest.REQUESTSHOWTYPE.DISPLAY
					&& dialog == null) {
