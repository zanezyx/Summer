...
public class AllOrderListActivity extends Activity {
	...
	private AllOrdersResponse oneMonthResponse;
	private AllOrdersRequest oneMonthRequest;
	private AllOrdersService oneMonthService;
	...
	public void loadData() {
		try {
			...
			oneMonthRequest = new AllOrdersRequest();
			oneMonthResponse = new AllOrdersResponse();
			oneMonthService = new AllOrdersService(this);
