...
import com.zyx.duomimanager.adapter.OneMonthAdapter;
...
import com.zyx.duomimanager.service.UserOrdersService;
...
public class UserOrderListActivity extends Activity {
	...
	private UserOrdersResponse oneMonthResponse;
	private UserOrdersRequest oneMonthRequest;
	private UserOrdersService oneMonthService;
	...
	public void loadData() {
		try {
			...
			oneMonthRequest = new UserOrdersRequest();
			oneMonthRequest.setMobile(mobile);
			oneMonthResponse = new UserOrdersResponse();
			oneMonthService = new UserOrdersService(this);
			...
			oneMonthService.request(new NetListener() {
				...
				public void onLoadSuccess(BaseResponse response) {
					...
					UserOrdersResponse res = (UserOrdersResponse) response;
					res.parseResString();
					getData();
					if(mData1!=null)
					{
